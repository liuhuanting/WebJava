...
public class TplCompile {
    ...
    /*
     * public static void main(String[] args) { TplCompile Compiler = new TplCompile();
     * Compiler.setTemplatePath(); Compiler.run("dd/test.html"); }
     */
    ...
    public Object run(String fileName) {
        ...
        String javaFile = this.TemplatePath + templateCompile.getFilePath(fileName) + "/"
                + templateCompile.getfileName(fileName) + "Template.java";
        ...
        try {
            ...
            Class cls = Class.forName(
                    "fm.liu.web.template." + templateCompile.getFilePath(fileName).replace("/", ".")
                            + templateCompile.getfileName(fileName) + "Template");
