...
public class StaticFileServer {
        ...
        try {
            ...
            if ((paramTime != null) && (Integer.parseInt((String) paramTime) <= lastTime)) {
                ...
                if (Options.DEBUG || Options.ParseLine) {
                    System.out.println(Response.Status + " " + this.request.Header.get("Host")
                            + this.request.Path);
                }
    ...
    public void read(SocketChannel socketChannel) {
        ...
        if (this.update()) {
            ...
            if (Options.DEBUG || Options.ParseLine) {
                System.out.println(
                        "Static File" + " " + this.request.Header.get("Host") + this.request.Path);
            }
            // 处理200
            BasicFileAttributeView basicView =
                    Files.getFileAttributeView(this.filePath, BasicFileAttributeView.class);
    ...
    private class CompletionHandlerImpl implements CompletionHandler<Integer, Object> {
        ...
        public void completed(Integer result, Object attachment) {
            ...
            String header = "HTTP/1.1 200 OK\r\n" + "Content-type: "
                    + Response.findContentType(StaticFileServer.this.ExName) + ";\r\n"
